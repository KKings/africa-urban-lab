...
const PageImageTitle = ({ fragment }: Props) => {
  const { pageTitle, pageImage, bgColor, pageBgImage } = getFragmentData(
  ...
  return (
    <div style={{ 
      ...
      backgroundImage: pageBgImage?.responsiveImage?.src ? `url(${pageBgImage?.responsiveImage?.src})` : 'none'
    }} className={clsx([
      ...
      <div className="container flex flex-col items-center space-y-w16">
        ...
        />
        <div className="inline-flex bg-background px-w4 py-3">
