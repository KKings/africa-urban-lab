      ...
      <div className="container py-12 md:py-24 bg-white">
        <div className="flex flex-wrap justify-center">
          <div className="w-full px-4 lg:w-8/12">
            <div>
              {data.research._publishedAt && (
                <Text size="meta" weight="bold" className="mb-5">
                  {transformDate(data.research._publishedAt)}
                </Text>
              )}
              <div className="mb-10 border-b border-body-color border-opacity-10 pb-6">
                <Text
                  as="h1"
                  className="font-bold leading-tight [&.text-base]:text-3xl [&.text-base]:sm:text-4xl sm:leading-tight"
                >
                  {data.research.title}
                </Text>
              </div>
