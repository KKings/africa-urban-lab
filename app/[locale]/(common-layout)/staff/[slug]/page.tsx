...
import { StaffStaticParamsDocument } from '@/graphql/types/graphql';
...
export async function generateStaticParams() {
  ...
  const { allAuthors } = await queryDatoCMS(StaffStaticParamsDocument);

  return allAuthors.flatMap((page) =>
